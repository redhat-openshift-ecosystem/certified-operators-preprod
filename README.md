# Redhat Marketplace operators pre-production catalog
...
Branches in this repository (`stage`, `dev`, `qa`) correspond to preprod environments. If you want to test an operator submission in QA environment a pull request needs to be open against `qa` branch.
